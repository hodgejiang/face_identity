...
<div class="wrap_right">
    ...
    <div id="Contents">
        ...
        <ul id="PageNum">
            <li>
                <a href="${pageContext.request.contextPath}/Sign_infServlet?currentPage=1&rows=9&courseID=${pb.list[0].courseID}">首页</a>
            </li>

            <c:if test="${pb.currentPage > 1}">
                <li>
                    <a href="${pageContext.request.contextPath}/Sign_infServlet?currentPage=${pb.currentPage - 1}&rows=9&courseID=${pb.list[0].courseID}">上一页</a>
                </li>
            </c:if>
            <c:forEach begin="1" end="${pb.totalPage}" var="i">
                ...
                <c:if test="${pb.currentPage == i}">
                    <li class="active"><a
                            href="${pageContext.request.contextPath}/Sign_infServlet?currentPage=${i}&rows=9&courseID=${pb.list[0].courseID}">${i}</a>
                    </li>
                </c:if>
                <c:if test="${pb.currentPage != i}">
                    <li>
                        <a href="${pageContext.request.contextPath}/Sign_infServlet?currentPage=${i}&rows=9&courseID=${pb.list[0].courseID}">${i}</a>
                    </li>
                </c:if>
            </c:forEach>
            ...
            <c:if test="${pb.currentPage < pb.totalPage}">
                <li>
                    <a href="${pageContext.request.contextPath}/Sign_infServlet?currentPage=${pb.currentPage + 1}&rows=9&courseID=${pb.list[0].courseID}">下一页</a>
                </li>
            </c:if>
