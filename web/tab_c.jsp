...
<div id="MainForm">
    <div class="form_boxA">
        ...
        <button type="button" style="margin-left:91%;margin-top:5px" class="btn btn-primary" data-toggle="modal"
                data-target="#exampleModal" data-whatever="@fat">添加课程
        </button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="courseTime" class="form-control" id="coursetime"
                                               placeholder="">
                                    </div>
            ...
            <c:forEach items="${pb.list}" var="course_inf" varStatus="s">
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm"
                           href="${pageContext.request.contextPath}/Sign_infSameServlet?id=${course_inf.courseID}">
                        查看 </a></td>
                    <td><a class="btn btn-default btn-sm" data-toggle="modal" data-target="#exampleModal1${s.count}">
                        修改 </a>&nbsp;
                        ...
                        <div class="modal fade" id="exampleModal1${s.count}" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form class="form-horizontal" autocomplete="off"
                                          action="${pageContext.request.contextPath}/UpdateCourseServlet?id=${course_inf.courseID}"
                                          method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="courseName" class="form-control"
                                                               value="${course_inf.courseName}" placeholder="">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="coursetime" class="col-sm-2 control-label">总课时</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="courseTime" class="form-control"
                                                               value="${course_inf.courseTime}" placeholder="">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" name="classNum"
                                                               value="${course_inf.classNum}" placeholder="">
                                                    </div>
                                                    <div class="col-sm-4 tips"></div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" name="className">
                                                            ...
                                                            <c:if test="${course_inf.className == '计算机科学与技术211班'}">
                                                                ...
                                                                <option selected value="计算机科学与技术211班">计算机科学与技术211班
                                                                </option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" name="term">
                                                            <c:if test="${course_inf.term == '2021-2022学年 第一学期'}">
                                                                ...
                                                                <option>请选择</option>
                                                                <option selected value="2021-2022学年 第一学期">2021-2022学年
                                                                    第一学期
                                                                </option>
                                                                <option value="2021-2022学年 第二学期">2021-2022学年 第二学期
                                                                </option>
                                                            ...
                                                            <c:if test="${course_inf.term == '2021-2022学年 第二学期'}">
                                                                ...
                                                                <option>请选择</option>
                                                                <option value="2021-2022学年 第一学期">2021-2022学年 第一学期
                                                                </option>
                                                                <option selected value="2021-2022学年 第二学期">2021-2022学年
                                                                    第二学期
                                                                </option>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/Face_photoServlet?courseID=${course_inf.courseID}"
                              id="myForm${s.count}" enctype="multipart/form-data" method="post">

                            <a href="javascript:;" class="a-upload">
                                <input type="file" name="sign_photo" id="photo_face">上传照片
                            </a>
                            <a class="a-upload" data-toggle="modal" data-target="#myModal_1${s.count}">提交</a>
                        </form>

                        <div class="modal fade" id="myModal_1${s.count}" tabindex="-1" role="dialog"
                             aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel11">开始签到</h4>
                                    </div>
                                    <div class="modal-body">
                                        确认开始签到？
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                                        <a id="btnA${s.count}">
                                            <button type="button" class="btn btn-primary" id="button_p1">确认</button>
                                        </a>
...
<ul id="PageNum">
    ...
    <c:if test="${pb.currentPage > 1}">
        <li><a href="${pageContext.request.contextPath}/FindUserByPageServlet?currentPage=${pb.currentPage - 1}&rows=9">上一页</a>
        </li>
    </c:if>
    <c:forEach begin="1" end="${pb.totalPage}" var="i">
        ...
        <c:if test="${pb.currentPage == i}">
            <li class="active"><a
                    href="${pageContext.request.contextPath}/FindUserByPageServlet?currentPage=${i}&rows=9">${i}</a>
            </li>
        </c:if>
        <c:if test="${pb.currentPage != i}">
    ...
    <c:if test="${pb.currentPage < pb.totalPage}">
        <li><a href="${pageContext.request.contextPath}/FindUserByPageServlet?currentPage=${pb.currentPage + 1}&rows=9">下一页</a>
        </li>
    </c:if>
