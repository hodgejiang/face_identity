...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
    ...
    <frame src="${pageContext.request.contextPath}/HeadServlet"
    ...
    <frameset rows="100*" cols="220,*" scrolling="No"
        ...
        <frame src="${pageContext.request.contextPath}/Sign_infServlet" name="main" scrolling="yes" noresize="noresize"
