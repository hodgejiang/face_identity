...
<div id="pageAll">
    ...
    <div class="page ">
        ...
        <div class="bacen">
            ...
            <div class="bbD">&nbsp;&nbsp;&nbsp;&nbsp;
                账号ID：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${sessionScope.user.id}</div>

            <form action="${pageContext.request.contextPath}/ChangePwdServlet" method="get" id="form_1"
                  onsubmit="return check_123()">
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" placeholder="请输入6-12位的密码" class="input3"
                                                         id="pwd1" onblur="checkpwd1()"/><img class="imga"
                                                                                              src="img/ok.png"/><img
