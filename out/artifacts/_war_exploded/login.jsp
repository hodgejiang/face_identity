...
<!-- 登录body -->
    ...
    <div class="logDiv">
        ...
        <div class="logGet">
            ...
            <!-- 输入框 -->
            <form id="form1" name="form1" method="get" action="${pageContext.request.contextPath}/loginServlet" onsubmit="myFunction()">
            <div class="lgD">
            ...
            <div class="lgD">
                ...
                <div class="lgD" >
                    <table width="200">
                        ...
                        <tr>
                            <td><label>
                                <input type="radio" name="RadioGroup1" value="0" id="RadioGroup1_0"style="width: 15px; height: 15px"/>
                                教师端登录</label></td>
                            <td>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <td><label>
                                <input type="radio" name="RadioGroup1" value="1" id="RadioGroup1_1" style="width: 15px; height: 15px"/>
                                学生端登录</label></td>
                        </tr>
                    </table>
                </div>
                <div class="form-inline lgD ">
                    ...
                    <input type="text" name="verifycode" class="form-control" id="verifycode" placeholder="验证码" style="width: 100px; height: 30px"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
